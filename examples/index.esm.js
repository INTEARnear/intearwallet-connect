            ...
            const messageHandler = async (event) => {
                ...
                try {
                    ...
                    if (data.type === 'ready') {
                        ...
                        console.log('connected; ', data.accounts && data.accounts.length > 0);
                        resultReceived = true;
                        cleanup();
                        popup.close();
